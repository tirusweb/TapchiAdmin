            ...
            <div className="container mx-auto p-4">
                <div className="flex align-center justify-between">
                    ...
                    <div className="flex items-center flex-1 ml-10 mr-20">
                        <input className=" border-2 border-gray-200 items-start h-[30px] border-solid flex-1"></input>
                    ...
                    <button className="bg-green-500 text-xs hover:bg-green-600 text-white font-normal px-4 rounded">
                        CREATE
                    </button>
                </div>
                <div className=" border-b-2 mt-3 border-gray-200 border-solid "></div>
                <table className="table-auto overflow-y-auto  w-full mt-4">
                    <thead>
                        <tr>
                            <th className="px-4 font-semibold py-2"> #</th>
                            <th className="px-4 py-2 font-semibold text-left">Tiều đề</th>
                            <th className="px-4 py-2 font-semibold text-left">Tóm tắt</th>
                            <th className="px-4 py-2 font-semibold text-left">Xem</th>
                            <th className="px-4 py-2 font-semibold text-left">Trạng thái</th>
                            <th className="px-4 py-2 font-semibold text-left">Người đăng</th>
                            <th className="px-4 py-2 font-semibold text-left">Mã danh mục</th>
                            <th className="px-4 py-2 font-semibold text-left">chức năng</th>
                        </tr>
                    </thead>
                    <tbody>
                        {categories.map((category) => (
                            <tr className="odd:bg-gray-100" key={category.id}>
                                ...
                                <td className="border-none px-4 max-w-[300px] py-2 text-gray-600">{category.name}</td>
                                <td className="border-none px-4 max-w-[300px] py-2 text-gray-600">{category.title}</td>
                                <td className="border-none px-4 max-w-[100px] py-2 text-gray-600">{category.view}</td>
                                <td className="border-none px-4 max-w-[100px] py-2 text-gray-600">{category.status}</td>
                                <td className="border-none px-4 max-w-[100px] py-2 text-gray-600">
                                    {category.userPost}
                                </td>
                                <td className="border-none px-4 max-w-[100px] py-2 text-gray-600">{category.code}</td>
